...
cap = cv2.VideoCapture('/home/sarish/output.avi')
...
while (cap.isOpened()):
    ...
    f_image = cv2.putText(
        img, action, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0,), 2, cv2.LINE_AA)

    print("Error", error, "  /  Frame_mid",
          frame_mid, "  /  Mid_point", mid_point)
