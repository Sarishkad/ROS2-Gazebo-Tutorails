...
class NavigatorApp:
    def __init__(self):
        ...
        self.beer_path = os.path.join(get_package_share_directory(
            'autonomous_tb3'), 'models', 'beer', 'model.sdf')
        self.waiter_active_flag = False
        self.return_from_table = False
        self.set_initial_pose()

    def create_button(self, text, x, y):
        button = tk.Button(self.tk_button, text=text,
    ...
    def set_initial_pose(self):
        ...
        initial_pose.pose.position.y = 0.67
