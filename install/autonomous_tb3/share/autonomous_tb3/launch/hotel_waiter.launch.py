...
def generate_launch_description():
    ...
    hotel_path = os.path.join(get_package_share_directory(
        'autonomous_tb3'), 'world', 'hotel', 'model.sdf')
    table_path = os.path.join(get_package_share_directory(
        'autonomous_tb3'), 'models', 'table', 'model.sdf')
    config_dir = os.path.join(
        get_package_share_directory('autonomous_tb3'), 'config')
    map_file = os.path.join(config_dir, 'hotel_map.yaml')
    actor_path = os.path.join(get_package_share_directory(
        'autonomous_tb3'), 'models', 'actor', 'model.sdf')

    world_path = os.path.join(get_package_share_directory(
        'autonomous_tb3'), 'world', 'hotel', 'empty_world.world')
    ...
    x_pose = LaunchConfiguration('x_pose', default='-5.1')
